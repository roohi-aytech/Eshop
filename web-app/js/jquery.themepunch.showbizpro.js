...
(function (e, t) {
    ...
    function r(n) {
        n.find(".show_on_hover, .hovercover").each(function () {
            ...
            if (n.data("ie9") || n.data("ie"))e(this).animate({opacity: 0}, {duration: 200, queue: false}); else e(this).transit({opacity: 0}, {duration: 200, queue: false});
            r.hover(function () {
                e(this).find(".show_on_hover, .hovercover").each(function () {
                    var r = 1;
                    if (e(this).data("maxopacity") != t)r = e(this).data("maxopacity");
                    if (n.data("ie9") || n.data("ie"))e(this).animate({opacity: r}, {duration: 200, queue: false}); else e(this).transit({opacity: r}, {duration: 200, queue: false})
                })
            }, function () {
                e(this).find(".show_on_hover, .hovercover").each(function () {
                    if (n.data("ie9") || n.data("ie"))e(this).animate({opacity: 0}, {duration: 200, queue: false}); else e(this).transit({opacity: 0}, {duration: 200, queue: false})
    ...
    function s(t, n) {
        t.find(".reveal_opener").each(function () {
            var r = jQuery(this);
            r.click(function () {
                if (r.parent().hasClass("reveal_container"))var i = r.parent(); else var i = r.parent().find(".reveal_container");
                if (i.hasClass("revactive")) {
                    ...
                    if (t.data("ie9") || t.data("ie")) {
                        i.find(".reveal_wrapper").css({visibility: "visible"}).animate({height: "0px", opacity: 0}, {duration: 300})
                    } else {
                        i.find(".reveal_wrapper").css({visibility: "visible"}).transit({height: "0px", opacity: 0}, {duration: 300})
                    }
                    ...
                    setTimeout(function () {
                        ...
                        if (t.data("ie9") || t.data("ie")) {
                            i.find(".reveal_wrapper").css({visibility: "visible"}).animate({height: "100%", opacity: 1}, {duration: 300})
                        } else {
                            i.find(".reveal_wrapper").css({visibility: "visible"}).transit({height: "100%", opacity: 1}, {duration: 300})
                        }
                        i.find(".sb-vimeo-markup, .sb-yt-markup").each(function () {
                            var n = e(this);
                            if (n.hasClass("sb-vimeo-markup"))var r = t.data("vimeomarkup"); else var r = t.data("ytmarkup");
    ...
    function u(t, n) {
        ...
        if (t.data("das") != "on")t.swipe({data: t, swipeRight: function () {
            i.click()
        }, swipeLeft: function () {
            s.click()
        }, excludedElements: ".reveal_opener, a,  .linkicon, .notalone, .lupeicon, .hovercover, .showbiz-navigation, .sb-navigation-left, .sb-navigation-right", allowPageScroll: "auto"});
        var u;
    ...
    function a(t, n) {
        ...
        l.animate({scrollLeft: v + "px"}, {duration: 300, queue: false, complete: function () {
    ...
    function f(n, r, i) {
        ...
        i.data("step", step);
        u.css({width: "10000px"});
        if (n == 0)u.css({left: 0 - step * a + "px"}); else {
        ...
        setTimeout(function () {
            ...
            if (r.find(".tofullwidth.revactive .heightadjuster").length > 0) {
                ...
                if (r.data("ie9") || r.data("ie")) {
                    ...
                    u.parent().animate({height: t + b + "px"}, {duration: 300, queue: false})
                } else {
                    u.transit({height: t + b + "px", duration: 300, queue: false});
                    u.parent().transit({height: t + b + "px", duration: 300, queue: false})
                }
            }
        }, n + 210)
    }
    ...
    e.fn.extend({showbizpro: function (t) {
        ...
        return this.each(function () {
            ...
            if (t.carousel == "on")i.data("carousel", 1); else i.data("carousel", 0);
            ...
            if (t.dragAndScroll == "on") {
                o.find(".overflowholder").overscroll({driftTimeout: 0}).on("overscroll:dragstart",function () {
