...
// uses the new invitation methods but doesn't work because you can't invite on Messenger Connect 5.
class WindowsliveInvitation2Service {
    ...
    def getAuthDetails(callbackUrl) {
        if (!authService) {
            ...
            authService = new ServiceBuilder()
                    ...
                    .apiKey( CH.config.grails.plugin.invitation.windowslive.key as String )
                    .apiSecret( CH.config.grails.plugin.invitation.windowslive.secret as String )
