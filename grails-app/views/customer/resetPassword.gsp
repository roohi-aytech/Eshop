...
<div id='changePasseord'>
    <div class='inner'>
        ...
        <g:if test="${params.done}">

        </g:if>
        <g:else>
            <g:form controller="customer" action='saveResetPassword' method='POST' name='changePasseordForm'
                    id='changePasseordForm' class='cssform' autocomplete='off'>
                ...
                <p class="toolbar">
                    <input type='submit' id="submit" class="btn btn-primary" width="80px"
                           value='${message(code: "password.change.label")}'/>
                </p>
            </g:form>
        </g:else>
    </div>
...
<script type='text/javascript'>
    <!--
    (function () {
        document.forms['changePasseordForm'].elements['newPassword'].focus();
    })();
    // -->
</script>
</body>
