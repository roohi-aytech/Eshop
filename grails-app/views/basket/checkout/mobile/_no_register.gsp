...
<div id="no-sign-in">
    ...
    <form action='${createLink(uri: '/basket/storeCustomerInformationWithoutRegistration')}' method='POST'
          id="customerInformationForm" class='cssform' autocomplete='off' onsubmit="validateCustomerInformation()">

        <p>
            <label for='lastName'><g:message code="springSecurity.register.lastName.label"/>:</label>
            <span id="lastNameValidationMessage" class="validationError"></span>
        ...
        <p>
            ...
            <select name="sex" id="sex" style="display: block;width:100px;">
        ...
        <p>
            ...
            <input type='text' onblur="validateUsernameField()" class='text_' name='email' id='usernameField'
                   style="display: block"
        ...
        <p>
            ...
            <input type='text' class='text_' name='telephone' id='telephone' onblur="validateTelephoneNumber()"
                   style="display: block"
        ...
        <div>
            <input type='submit' id="submit" class="grn-btn"
                   value='${message(code: "enquiry.request.shopping.noRegister")}'/>
        </div>
    </form>
</div>