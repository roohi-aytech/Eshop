...
<td style="padding-left: 60px; display: table-cell">
    ...
    <div class="fieldcontain ${hasErrors(bean: producingProductInstance, field: 'productTypes', 'error')} ">
        ...
        <rg:tree bean="${producingProductInstance}" field="productTypes" onLoadSuccess="onLoadSuccess"
                 onChange="onProductTypeSelect" cascadeCheck="false" relationField="parentProduct"
                 width="250px"></rg:tree>
    </div>
    ...
    <fieldset>
        ...
        <div class="fieldcontain ${hasErrors(bean: producingProductInstance, field: 'volumeDescription', 'error')}">
            ...
            <g:textField name="volumeDescription" value="${producingProductInstance?.volumeDescription}"
                         class="count-words"/>
            <script type="text/javascript">
                $(function () {
        ...
        <div class="fieldcontain ${hasErrors(bean: producingProductInstance, field: 'retailDescription', 'error')} ">
            ...
            <g:textField name="retailDescription" value="${producingProductInstance?.retailDescription}"
                         class="count-words"/>
            <script type="text/javascript">
                $(function () {
    ...
    <fieldset>
        ...
        <div class="fieldcontain ${hasErrors(bean: producingProductInstance, field: 'priceType', 'error')} ">
            ...
            <g:select name="priceType" from="${producingProductInstance.constraints.priceType.inList}"
                      value="${producingProductInstance?.priceType}"
        ...
        <div class="fieldcontain ${hasErrors(bean: producingProductInstance, field: 'discountType', 'error')} ">
            ...
            <g:select name="discountType" from="${producingProductInstance.constraints.discountType.inList}"
                      value="${producingProductInstance?.discountType}"
...
<td style="display: table-cell">
    ...
    <div class="fieldcontain ${hasErrors(bean: producingProductInstance, field: 'refundable', 'error')} ">
        ...
        <g:select name="refundable" from="${producingProductInstance.constraints.refundable.inList}"
                  value="${producingProductInstance?.refundable}"
    ...
    <div class="fieldcontain ${hasErrors(bean: producingProductInstance, field: 'testPeriod', 'error')} ">
        ...
        <g:select name="testPeriod" from="${producingProductInstance.constraints.testPeriod.inList}"
    ...
    <div class="fieldcontain ${hasErrors(bean: producingProductInstance, field: 'addedValue', 'error')} ">
        ...
        <g:select name="addedValue" from="${producingProductInstance.constraints.addedValue.inList}"
                  value="${producingProductInstance?.addedValue}"
                  valueMessagePrefix="producingProduct.addedValue" noSelection="['': '']"/>

        <g:field id="addedValueDescription" type="number" name="addedValueDescription" step="any"
                 value="${producingProductInstance?.addedValueDescription}"/>
