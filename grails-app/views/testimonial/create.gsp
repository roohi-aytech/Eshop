...
<body>
<a href="#create-testimonial" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="create-testimonial" class="content scaffold-create" role="main">
