...
<html>
	...
	<body>
		<a href="#create-cultureEvent" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-cultureEvent" class="content scaffold-create" role="main">
