...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${resource(dir: 'css/mobile', file: 'checkout.css')}"/>
    <script type="text/javascript"
    ...
    <r:layoutResources/>
    <g:layoutHead/>
    <link rel="stylesheet" type="text/css" href="${resource(dir: 'css/mobile', file: "${grailsApplication.config.eShop.instance}.css")}">
</head>
...
<div class="main-width">
    <g:layoutBody/>
    <g:render template="/layouts/${grailsApplication.config.eShop.instance}/mobile/footer"/>
</div>
