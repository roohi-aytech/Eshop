...
<div id="no-sign-in">
    <g:form action="onlinePayment">
        ...
        <g:if test="${grailsApplication.config.paymentValueUserSelect}">
            ...
            <label><g:message code="order.payment.value"></g:message> <g:formatNumber number="${orderPrice}"
                                                                                      type="number"/> (<eshop:currencyLabel/>)</label>
        </g:if>
        <g:else>
        ...
        <div class="toolbar" style="margin-top:10px;">
            <input type="submit" class="grn-btn full" onclick="return onlineValidate()" style="background:linear-gradient(to top, #aec737, #c3da55);color:black;margin:0;"
