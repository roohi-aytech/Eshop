...
<div class="page-content">
    ...
    <p>
        روش های ارسال، هزینه، مدت زمان آن و نحوه پرداخت وجه کالا در فروشگاه اینترنتی زنبیل بسته به محل سکونت مشتری و نحوه دریافت کالا متفاوت می باشد. ضمناً منظور از پرداخت توسط سیستم POS، امکان پرداخت از طریق کارت های بانکی با دستگاه کارت خوان بی سیم است.
    </p>
