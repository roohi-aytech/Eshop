<div class="slideshowContainer">
    <div id="slideshowMain">
        ...
        <a href="http://spidermandimensions.marvel.com/" target="_blank">
            <img src="http://workshop.rs/projects/coin-slider/games/spiderman_shattered_dimensions.jpg"
                 alt="Spiderman: Shattered Dimensions"/>
        </a>
        ...
        <a href="http://www.swtor.com/" target="_blank">
            <img src="http://workshop.rs/projects/coin-slider/games/star_wars_the_old_republic.jpg"
                 alt="Star Wars: The Old Republic"/>
        </a>

        <a href="http://www.batmanarkhamasylum.com/" target="_blank">
            <img src="http://workshop.rs/projects/coin-slider/games/batman_arkham_asylum.jpg"
