                            ...
                            <li class="sb-showcase-skin">
                                <g:if test="${type == 'filter'}">
                                    <a href="${createLink(controller: "site", action: "filter", params: params + [f: "${params.f},p${productTypeLink._id.id}"])}">
                                        <img src="${createLink(controller: 'image', params: [type: 'productType', id: productTypeLink._id.id, wh: '240x180'])}" width="240" height="180"
                                ...
                                <g:else>
                                    <a href="${productTypeLink.href}">
                                        <img src="${createLink(controller: 'image', params: [type: 'productType', id: productTypeLink.id, wh: '240x180'])}" width="240" height="180"
