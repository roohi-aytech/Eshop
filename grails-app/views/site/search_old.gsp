...
<div id="main">
    <div class="layout-container table">
        <div class="table-row">
            ...
            <g:set var="haveResults" value="${filters.searchResult?.results}"/>
                            ...
                            <div class="table">
                                <div class="table-row">
                                    <div class="span600 table-cell">
                                            ...
                                            <span>
                                                <g:if test="${haveQuery && haveResults}">
                                                    ...
                                                    <div class="resultCounter"><g:message code="search.resultCounter"
                                                                                          args="${[filters.searchResult.offset + 1, filters.searchResult.results.size() + filters.searchResult.offset, filters.searchResult.total]}"/></div>
                                                </g:if>
                                        ...
                                        <g:if test="${filters.searchResult?.suggestedQuery}">
                                            <p>Did you mean <g:link controller="searchable" action="index"
                                                                    params="[q: filters.searchResult.suggestedQuery]">${StringQueryUtils.highlightTermDiffs(params.phrase.trim(), filters.searchResult.suggestedQuery)}</g:link>?</p>
                                        </g:if>
