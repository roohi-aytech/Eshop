...
//    public static final String ACTION_REACTIVATION = "reactivation";
    ...
    public static final def ACTION_LIST = [ACTION_CREATION, ACTION_MARK_AS_INCORRECT, ACTION_APPROVE, ACTION_INQUIRY, ACTION_MARK_AS_INCOMPLETE, ACTION_COMPLETION, ACTION_PAYMENT_CORRECTION, ACTION_DECLINE_PAYMENT, ACTION_APPROVE_PAYMENT, ACTION_TRANSMISSION, ACTION_MARK_AS_NOT_EXIST, ACTION_RE_APPROVE, ACTION_DELIVERY]
}
