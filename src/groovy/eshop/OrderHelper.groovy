...
class OrderHelper {
    ...
    public static final def STATUS_LIST = [STATUS_CREATED, STATUS_INQUIRED, STATUS_PAID, STATUS_CANCELLED, STATUS_TRANSMITTED, STATUS_DELIVERED]
    ...
    public static final def ACTION_LIST = [ACTION_CREATION, ACTION_INQUIRY, ACTION_PAYMENT, ACTION_CANCELLATION, ACTION_TRANSMISSION, ACTION_DELIVERY, ACTION_REACTIVATION]
}
