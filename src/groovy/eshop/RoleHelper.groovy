...
class RoleHelper {
    ...
    public static final def visibleRoles = [ROLE_USER_ADMIN, ROLE_PRICE_ADMIN, ROLE_PRODUCT_ADMIN, ROLE_PRODUCT_TYPE_ADMIN, ROLE_PRODUCER_ADD, ROLE_PRODUCER_ADD_EDIT, ROLE_PRODUCT_ADD, ROLE_PRODUCT_ADD_EDIT, ROLE_VENDOR]
