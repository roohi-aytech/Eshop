...
public class SmsLocator extends org.apache.axis.client.Service implements eshop.sms.sms1000.Sms {
    ...
    public eshop.sms.sms1000.SmsSoap_PortType getsmsSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            eshop.sms.sms1000.SmsSoap12Stub _stub = new eshop.sms.sms1000.SmsSoap12Stub(portAddress, this);
    ...
    public eshop.sms.sms1000.SmsSoap_PortType getsmsSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            eshop.sms.sms1000.SmsSoap_BindingStub _stub = new eshop.sms.sms1000.SmsSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (eshop.sms.sms1000.SmsSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                eshop.sms.sms1000.SmsSoap12Stub _stub = new eshop.sms.sms1000.SmsSoap12Stub(new java.net.URL(smsSoap12_address), this);
                _stub.setPortName(getsmsSoap12WSDDServiceName());
                return _stub;
            }
            if (eshop.sms.sms1000.SmsSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                eshop.sms.sms1000.SmsSoap_BindingStub _stub = new eshop.sms.sms1000.SmsSoap_BindingStub(new java.net.URL(smsSoap_address), this);
                _stub.setPortName(getsmsSoapWSDDServiceName());
                return _stub;
            }
        }
